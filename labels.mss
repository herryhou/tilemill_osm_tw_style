...
/* ROAD LABELS
/* ================================================================== */
#motorway_label[type='motorway'][zoom>=7][zoom<=16][reflen<=8] {
  shield-name: "[ref]";
  shield-size: 9;
  ...
  [zoom<=9] { shield-min-distance: 100; } //60
  [zoom<=11] { shield-min-distance: 60; } //60
  [zoom=12] { shield-min-distance: 70; } //80
  [zoom=13] { shield-min-distance: 80; } //120
  [zoom>=14] { shield-min-distance: 100; } //180
}

#motorway_label[type='trunk'][zoom>=7][zoom<=16][reflen<=8] {
  shield-name: "[ref]";
  shield-size: 9;
  shield-face-name: @sans_bold;
  shield-fill: #fff;
...
#mainroad_label[type='primary'][zoom>=11][zoom<=18][reflen<=8],
#mainroad_label[type='secondary'][zoom>=11][zoom<=18][reflen<=8]{
  shield-name: "[ref]";
  shield-size: 9;
  shield-face-name: @sans_bold;
  shield-fill: #000;
  shield-file: url(img/shield-secondary-1.png);
  [type='primary'] {
    shield-fill: #FFF;
    shield-text-dy: -2;
    shield-text-dx: 0;
  ...
  [type='secondary'] {
    [reflen=1] { shield-file: url(img/shield-secondary-1.png); }
    [reflen=2] { shield-file: url(img/shield-secondary-2.png); }
    [reflen=3] { shield-file: url(img/shield-secondary-3.png); }
    [reflen>=4] { shield-file: url(img/shield-secondary-4.png); }
  }
  [zoom<=13] { shield-min-distance: 80; } //120
  [zoom=14] { shield-min-distance: 90; }
  [zoom>=15] { shield-min-distance: 100; } //180
}
...
#place::city[type='city'][zoom>=8][zoom<=15] {
  ...
  text-halo-radius:2;
  [zoom<=8] {
    text-size: 10 + @road_label_adjust;
    text-halo-radius:1;
  }
  [zoom=9] {
    text-size:10;
    text-wrap-width: 60 + @road_label_adjust;
  }
  [zoom=10] {
    text-size:11;
    text-wrap-width: 70 + @road_label_adjust;
  }
  [zoom=11] {
    text-size:12 + @road_label_adjust;
    text-character-spacing: 1;
    text-wrap-width: 80;
  }
  [zoom=12] {
    text-size:13 + @road_label_adjust;
    text-character-spacing: 1;
    text-wrap-width: 100;
  }
  [zoom=13] {
    text-size:14 + @road_label_adjust;
    text-character-spacing: 2;
    text-wrap-width: 200;
    text-transform: uppercase;
  }
  [zoom=14] {
    text-size:15 + @road_label_adjust;
    text-character-spacing: 4;
    text-wrap-width: 300;
    text-transform: uppercase;
  }
  [zoom=15] {
    text-size:16 + @road_label_adjust;
...
#place::town[type='town'][zoom>=9][zoom<=17] {
  ...
  [zoom>=11]{ text-size:11 + @road_label_adjust; }
  [zoom>=12]{
    text-size:12 + @road_label_adjust;
    text-line-spacing: 1;
  }
...
#area_label {
  ...
  [zoom>=18][area>=0] {
    ...
    text-face-name:@sans;
    text-size: 11 + @road_label_adjust;
    text-wrap-width:30;
    text-fill: #888;
    text-halo-fill: #fff;
  ...
  [zoom>=18][area>80000] {
    text-size: 20 + @road_label_adjust;
    text-character-spacing: 3;
    text-wrap-width: 180;
  }
}
...
#minorroad_label[zoom>14] {
  ...
  text-placement:line;
  text-size:10 + @road_label_adjust;
  text-fill:lighten(@road_text,10%);
  text-halo-fill:@road_halo;
  text-halo-radius:1;
  text-min-distance:60;
}
